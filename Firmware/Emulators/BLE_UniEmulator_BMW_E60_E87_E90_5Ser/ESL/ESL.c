...
const BmwResponseData_t BmwResponseData[] = { // BMW E90
	{ 40, 15, {0x80, 0x0D, 0x00, 0x45, 0x59, 0xB2, 0x11, 0x04, 0x00, 0x00, 0x6B, 0x98, 0x12, 0xFA, 0x2D } }, // TURN_ON
...
void ELV_Init(void)
{
	...
	memcpy(BmwResponse.data, BmwResponseData[EIS_TURN_ON].data, BmwResponse.len);
}
//**************************************************
